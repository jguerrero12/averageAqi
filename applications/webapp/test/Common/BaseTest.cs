...
{
    protected CustomWebApplicationFactory<Program> App { get; }
    protected HttpClient Client { get; }
    protected ITestHarness _testHarness { get; }
    ...
    protected BaseTest(CustomWebApplicationFactory<Program> apiFactory)
    {
        App = apiFactory;
        _testHarness = App.Services.GetTestHarness();
